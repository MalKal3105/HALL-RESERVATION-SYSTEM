<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    <h3 class="mb-0">ADMIN PANEL RESERVE SYSTEM</h3>
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse show px-3 small mb-1" id="bookingLinks">
                            <ul class="nav nav-pills flex-column rounded border border-secondary">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="booking_records.php">Record Bookings</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="hall.php">Halls</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="features_facilities.php">Features & Facilities</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="carousel.php">Carousels</a>
                    </li>
                    <li class="nav-item">
